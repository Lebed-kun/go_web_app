  ...
  if (props.tasks) {
    content = props.tasks.map(function (el, id) {
      return __jsx(antd__WEBPACK_IMPORTED_MODULE_4__["Col"], {
        ...
        key: id,
        title: el.Title ? el.Title : el.Text.slice(0, 20),
        __source: {
          fileName: _jsxFileName,
          lineNumber: 15
        },
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            _context.next = 3;
            return axios__WEBPACK_IMPORTED_MODULE_7___default.a.request("".concat(_constants_js__WEBPACK_IMPORTED_MODULE_6__["REST_BASE_URL"], "/"));
...
//# sourceMappingURL=index.js.09b2ae2fee9dd011c1a3.hot-update.js.map